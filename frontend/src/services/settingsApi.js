...
// Beim Login starten mehrere Contexts (Theme, Ball, Display) gleichzeitig einen
// Abruf. Damit daraus nicht drei identische GETs werden, teilen sich alle
// Aufrufer denselben laufenden Request (In-Flight-Dedup). Nach Abschluss wird
// zurueckgesetzt, damit ein spaeterer Login frische Daten holt.
let inflight = null;
...
export function getSettings() {
  ...
  return inflight; // { theme, ball, displayStat }
}
...
export function readLocalSettings() {
  const keys = ["theme", "ball", "displayStat"];
  const out = {};

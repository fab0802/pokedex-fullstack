...
// Hinweis: PokéAPI hat (Stand 2026) keine Fundort-Daten für Gen 8/9.
// swsh und sv werden lokal aus src/data/encounters/*.json bedient
// (siehe services/localEncounters.js, Weiche über hasLocalEncounters()).
